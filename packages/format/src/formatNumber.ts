...
export function formatNumber(
	...
	const { removeTrailingZeros = true, addThousandsSeparator = true } = mergedOptions;
	...
	if (typeof value === 'string') {
		...
		return formatValidNumber(parsedNumber, removeTrailingZeros, addThousandsSeparator);
	}
